    ...
    list: [
      {
        ...
        link: [
          ...
          { name: "多吉搜索", url: "https://www.dogedoge.com/" },
        ],
      },
      {
        tag: "社交",
        link: [
          ...
          { name: "微博手机版", url: "https://m.weibo.cn/" },
          { name: "简书", url: "https://www.jianshu.com/" },
          { name: "仿夸克", url: "https://liumingye.gitee.io/quarkhomepage/" },
        ],
      },
      {
        tag: "资讯",
      ...
      },
      {
        ...
        link: [
          ...
          {
            name: "慢慢买",
            url: "http://tool.manmanbuy.com/HistoryLowest.aspx",
          },
      ...
      },
      {
        ...
        link: [
          ...
          { name: "斗鱼直播", url: "https://m.douyu.com/" },
      ...
      },
      {
        tag: "工作",
        link: [
          { name: "Todolist", url: "http://www.todolist.cn/" },
          { name: "断句-脑图", url: "abc.html" },
      ...
      },
      {
        ...
        link: [
          ...
          { name: "今日诗词", url: "https://www.jinrishici.com/" },
          { name: "高考倒计时", url: "https://time.learnonly.xyz" },
      ...
      },
      {
        tag: "便捷",
        link: [
          { name: "青柠起始页", url: "https://a.maorx.cn/" },
          { name: "随机分组", url: "https://group.learnonly.xyz" },
          { name: "墨灵音乐", url: "https://yinyue.qugeek.com/" },
          { name: "18班课程表", url: "ke.png" },
          { name: "思谷搜", url: "https://www.siguso.com/" },
    ...
    list: [
      {
        ...
        link: [
          ...
          { name: "在线五子棋", url: "https://www.playok.com/zh/gomoku/" },
          { name: "在线棋类", url: "https://www.playok.com/" },
      ...
      },
      {
        ...
        link: [
          ...
          { name: "腾讯斗地主", url: "https://hlddz.huanle.qq.com/" },
      ...
      },
      {
        ...
        link: [
          ...
          { name: "起点手机版", url: "https://m.qidian.com/" },
        ],
      },
    ],
  },
    ...
    list: [
      {
        ...
        link: [
          ...
          { name: "知心慧学答案", url: "http://note.youdao.com/s/BU3d1qPI" },
      ...
      },
      {
        ...
        link: [
          ...
          { name: "维基镜像备用", url: "https://www.wanweibaike.com/" },
      ...
      },
      {
        tag: "学术",
        link: [
          { name: "学术", url: "https://scholar.google.com/" },
      ...
      },
      {
        ...
        link: [
          ...
          {
            name: "百词斩词汇量",
            url: "https://vocabulary.baicizhan.com/new_vocabulary/index.html",
          },
          {
            name: "有道词汇量",
            url: "https://c.youdao.com/market/recite-vocabulary/index.html",
          },
          {
            name: "计算机等级",
    ...
    list: [
      ...
      },
      {
        ...
        link: [
          ...
          { name: "全屏时钟", url: "https://clock.learnonly.xyz/" },
    ...
    list: [
      ...
      },
      {
        ...
        link: [
          ...
          { name: "MdEditor", url: "http://www.mdeditor.com/" },
          { name: "TinyPNG", url: "https://tinypng.com/" },
        ],
      },
      {
...
!(function (o) {
  ...
  function a(t) {
    if (
      ...
      o(".search-form").attr("action", "https://quark.sm.cn/s"),
        o(".search-keyword").attr({
          name: "q",
          placeholder: "搜索,就该更好的!",
        });
      ...
      o(".search-form").attr("action", "https://duckduckgo.com/"),
        o(".search-keyword").attr({
          name: "q",
